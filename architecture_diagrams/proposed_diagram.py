...
with Diagram("Proposed Diagram", show=False, direction="LR"):
  ...
  with Cluster("Cloud"):
    ...
    with Cluster("API's"):
      ...
      vertex = Custom("Vertex AI", "./data/images/vertex.png")
    ...
    dag2 >> Edge(label="Gesture recognisiton model") >> vertex
    vertex >> Edge(label="Stores data") >> s3
