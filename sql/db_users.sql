...
INSERT INTO user_current_usage VALUES('user_free','0','0','0',DateTime('now'),DateTime('now'),DateTime('now'));
INSERT INTO user_current_usage VALUES('user_gold','0','0','0',DateTime('now'),DateTime('now'),DateTime('now'));
INSERT INTO user_current_usage VALUES('user_platinum','0','0','0',DateTime('now'),DateTime('now'),DateTime('now'));